...
export const getquerysImages = async (req, res) => {
    ...
    try {
        ...
        const [comidas] = await pool.query("SELECT id, user_id, name, description, image, price, categoria, tipo_control, tamanio, controlUnidad FROM comidas WHERE user_id = ?", [idVaner[0].id])
